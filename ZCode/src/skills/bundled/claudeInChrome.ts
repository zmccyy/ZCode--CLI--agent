...
import { getClaudeInChromeBrowserToolNames } from '../../utils/claudeInChrome/browserTools.js'
import { shouldAutoEnableClaudeInChrome } from '../../utils/claudeInChrome/setup.js'
import { registerBundledSkill } from '../bundledSkills.js'

const CLAUDE_IN_CHROME_MCP_TOOLS = getClaudeInChromeBrowserToolNames().map(
