...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when ZCode was first started on this machine
  ...
  // ZCode usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first ZCode OAuth token
  ...
  // ZCode hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
