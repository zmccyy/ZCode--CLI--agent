// Runtime model catalog for environments that execute the public CLI without a TS loader.
// Keep this file aligned with configs.ts.
...
export const CANONICAL_ID_TO_KEY = Object.fromEntries(
  Object.entries(ALL_MODEL_CONFIGS).map(([key, config]) => [
    config.firstParty,
    key,
  ]),
)
