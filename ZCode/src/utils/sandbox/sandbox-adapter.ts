...
/**
 * Resolve ZCode-specific path patterns for sandbox-runtime.
 *
 * ZCode uses special path prefixes in permission rules:
...
/**
 * Convert ZCode settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where ZCode started)
